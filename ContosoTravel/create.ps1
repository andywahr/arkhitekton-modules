...
$name = "TestDeploy_$([DateTime]::Now.ToString('yyyyMMddHHmmss'))"
...
& az group deployment create --name $name --resource-group rg-contosotravel-test1 --template-file .\azuredeploy.json --parameters namePrefix=andytst1 --debug
[DateTime]::Now.ToString()